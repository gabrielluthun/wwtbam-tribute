...
export const THEMES = {
  ...
  adultes_18: {
    ...
    questions: [
      q('Que prépare principalement un mixologue ?', ['Des cocktails', 'Des pâtisseries', 'Des sushis', 'Des vins'], 'A'),
      q('De quelle couleur sont les lumières du célèbre quartier "chaud" d\'Amsterdam ?', ['Bleues', 'Rouges', 'Jaunes', 'Vertes'], 'B'),
      q('Quel cocktail associe vodka, jus de tomate et épices ?', ['Mojito', 'Margarita', 'Bloody Mary', 'Piña Colada'], 'C'),
      ...
      q('Quel organe humain compte environ 8 000 terminaisons nerveuses, soit le plus dense du corps ?', ['Le gland', 'Le clitoris', 'La langue', 'Le téton'], 'B'),
      ...
      q('En quelle année est sorti le film français "Emmanuelle", qui battit des records d\'entrées ?', ['1972', '1974', '1978', '1982'], 'B'),
      q('Quel écrivain français, mort en 1814, donna son nom au mot "sadisme" ?', ['Balzac', 'Hugo', 'Le Marquis de Sade', 'Flaubert'], 'C'),
      q('Quel est le terme médical pour désigner la peur de la nudité ?', ['Claustrophobie', 'Agoraphobie', 'Gymnophobie', 'Xénophobie'], 'C'),
      q('Combien de positions sont traditionnellement décrites dans le Kâma-Sûtra ?', ['64', '108', '216', '365'], 'A'),
      q('Quel philosophe français a publié "Histoire de la sexualité" entre 1976 et 1984 ?', ['Sartre', 'Michel Foucault', 'Deleuze', 'Bourdieu'], 'B'),
    ],
  },
  ...
  sexe_anatomie: {
    ...
    questions: [
      q('Quel organe masculin produit les spermatozoïdes ?', ['Le pénis', 'Les testicules', 'La prostate', 'L\'urètre'], 'B'),
